...
# Run this as Administrator to connect to PMACS VPN
...
Write-Host "  - Enter your password when prompted" -ForegroundColor White
Write-Host "  - Approve the DUO push on your phone" -ForegroundColor White
Write-Host "  - Press Ctrl+C to disconnect" -ForegroundColor White
Write-Host ""
